...
public class SearchController {
        ...
        keyword값을 이용하여 조회후 값을 가져오게 됨
         */
        @GetMapping("/noraebang")
        public Response<List<NoraebangDto>> searchMoreNoraebang(@RequestParam("keyword") String keyword) throws Exception{
                return Response.of("OK","노래방 더보기",searchService.getSearchMoreNoraebangTitle(keyword));
        }
         ...
         */
        @GetMapping("/cover")
        public Response<List<CoverDto>> searchMoreCover(@RequestParam("keyword") String keyword) throws Exception{
               return Response.of("OK","커버 더보기",searchService.getSearchMoreCoverTitle(keyword));
        }
}
